...
L= ["Diego Maradona","elon musk" ,"Lionel Messi", "cristiano ronaldo" ,"Angela Merkel" , "taylor swift" ,"Natti Natasha", "Gad Elmaleh" , "Moncef Slaoui","warren buffett" , "Emmanuel Macron", "Saad Lamjarred","Don Bigg"]
print(generate_dataframe(L))
